...
Советую брать вариант с Swing, поскольку в JavaFX могут возникнуть большие проблемы с подключением файлом .fxml (во-первых траблы при подключении, во-вторых надо верстать страничку, условно писать html код)
