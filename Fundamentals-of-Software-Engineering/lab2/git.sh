...
git config user.email "red@red.red"
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 2 (r2)"
echo "--- Коммит 2 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 4 (r4)"
echo "--- Коммит 4 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 6 (r6)"
echo "--- Коммит 6 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 7 (r7)"
echo "--- Коммит 7 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 10 (r10)"
echo "--- Коммит 10 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 11 (r11)"
echo "--- Коммит 11 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 13 (r13)"
echo "--- Коммит 13 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 16 (r16)"
echo "--- Коммит 16 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 17 (r17)"
echo "--- Коммит 17 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 20 (r20)"
echo "--- Коммит 20 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 22 (r22)"
echo "--- Коммит 22 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 27 (r27)"
echo "--- Коммит 27 (blue)"
# }
...
git add .
git commit --author="blue <blue@blue.blue>" -m "Revision 29 (r29)"
echo "--- Коммит 29 (blue)"
# }
